...
function getRandomLyric() {
  ...
  console.log(`Random Lyric: ${selectedLyric}`); /*print to console a random lyric from the array*/
}
...
function getRockTrivia() {
  ...
  console.log(`Rock Trivia: ${selectedTrivia}`); /*print to console a random trivia question from the array*/
}
...
function getCurrentDate() {
  ...
  console.log(`Today's Date: ${today.toLocaleDateString(undefined, options)}`); /*print to console the current date in a readable format*/
}


/*could also use return instead of console.log to return values from functions,
  but for this example, console.log is used to demonstrate the output directly*/
